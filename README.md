...
There is a rewrite to [external component](https://esphome.io/components/external_components) in the `external-component` branch. Feel fre to test it out and report any issues!
